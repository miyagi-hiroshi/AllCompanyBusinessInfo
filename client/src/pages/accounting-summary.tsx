...
export default function AccountingSummaryPage() {
  ...
  // 月次サマリデータ取得
  const { data: summaryData, isLoading } = useAccountingSummary(
    selectedYear,
    includeAngleB,
    selectedSalesPerson
  );
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow className={getSummaryColor("revenue")}>
                    <TableCell colSpan={2} className="text-xs py-1 px-2">
                      純売上計
                    </TableCell>
                    {months.map((month) => (
                      <TableCell key={month} className="text-right font-mono text-xs py-1 px-2">
                  ...
                  <TableRow className={getSummaryColor("costOfSales")}>
                    ...
                    <TableCell className="text-right font-mono font-bold text-xs py-1 px-2">
                      {formatCurrency(
                        calculateSummaryAnnualTotal(summaries.costOfSales.monthlyTotals)
                      )}
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow className={getSummaryColor("sgaExpenses")}>
                    ...
                    <TableCell className="text-right font-mono font-bold text-xs py-1 px-2">
                      {formatCurrency(
                        calculateSummaryAnnualTotal(summaries.sgaExpenses.monthlyTotals)
                      )}
                    </TableCell>
                  </TableRow>
                </TableBody>
